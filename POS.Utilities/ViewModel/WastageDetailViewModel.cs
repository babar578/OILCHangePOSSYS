...
{
    public class WastageDetailViewModel
    {
        ...
        public WastageHeadViewModel WastageHead { get; set; }
        public System.DateTime TransactionDate { get; set; }
        public string ItemName { get; set; }

        public static implicit operator WastageDetailViewModel(WastageDetail detail)
        {
            if (detail == null)
                return null;

            return new WastageDetailViewModel()
            {
                Id = detail.Id,
        ...
        public static implicit operator WastageDetail(WastageDetailViewModel detail)
        {
            if (detail == null)
                return null;
