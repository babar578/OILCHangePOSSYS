...
{
    public class VendorToWarehouseDetailViewModel
    {
        ...
        public static implicit operator VendorToWarehouseDetailViewModel(VendorToWarehouseDetail detail)
        {
            if (detail == null)
                return null;

            return new VendorToWarehouseDetailViewModel()
            {
                Id = detail.Id,
        ...
        public static implicit operator VendorToWarehouseDetail(VendorToWarehouseDetailViewModel detail)
        {
            if (detail == null)
                return null;

            return new VendorToWarehouseDetail()
            {
                Id = detail.Id,
                AdjustmentIN = detail.AdjustmentIN,
                AdjustmentOUT = detail.AdjustmentOUT,
