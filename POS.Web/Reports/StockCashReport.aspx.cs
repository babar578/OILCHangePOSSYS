...
{
    public partial class StockCashReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("StockCashReport.rdlc");
                ...
                List<Sp_StockInCashReport> list = ReportServices.GetSockinHandCashReport(fromDate, toDate).ToList();
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[StockCashReport] Error: {ex.Message}");
